...
API_HOME = 'http://myapi:3000/entity/deaffiliate_entity/'
#API_HOME = 'http://myapi:3000/session/create_session/'
 
# Scenarios
 
scenarios('../features/deaffiliateentity.feature')
...
@when(parsers.parse('a Delete request for an endpoint /entity/deaffiliate_entity/ is triggered to deaffiliate an entity for scheduler block'), target_fixture = 'post_request')
def post_request():
    pass
